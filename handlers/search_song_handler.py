...
from userbot.utils.main_spotify_search_func import get_spotify_track_info
from userbot.utils.yandex_music_search_func import get_yandex_music_url
from userbot.utils.songlink_search import get_songlink_url
from userbot.utils.create_card_func import create_song_card
...
async def song_search_handler(event, client):
    ...
    if track_info:
        ...
        logger.info(f"Время выполнения: {end_time - start_time:.5f} секунд.")
    else:
